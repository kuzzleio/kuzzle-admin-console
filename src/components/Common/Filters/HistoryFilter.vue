<template>
  <ul class="list-group">
    ...
    <template v-else>
      <h4 class="text-secondary text-center">You haven't performed any search yet.</h4>
      <p class="text-secondary text-center">You'll find all your searches in this history.</p>
    </template>
  </ul>
</template>
