<template>
  <div class="CollectionForm wrapper">
    <div v-if="Object.keys(flattenMapping).length > 0">
      ...
      <p>
        Here, you'll be able to associate mapping fields to form fields to setup a form that will ease the creation of
    ...
    <div
      v-else
      class="CollectionForm-noMapping"
    >
      <h4>You are creating a collection with an empty mapping.</h4>
      <p>
        This is OK, since <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/dynamic-field-mapping.html">
        ...
        you may need to know before proceeding.
      </p>
      ...
      <ul>
        ...
        <li>
          If you want to edit the mapping of the current collection, once it's created, you can click on "Edit collection" in the context,
        ...
        <li>
          Once your collection has a mapping, you can associate its fields with a set of form fields using this wizard. This will enable
