<template>
  <div class="CollectionForm wrapper">
    <div v-if="Object.keys(flatMapping).length > 0">
      ...
      <p>
        Here, you'll be able to associate mapping fields to form fields to setup a form that will
        ease the creation of documents in this collection.
      </p>
    ...
    <div v-else class="CollectionForm-noMapping">
      ...
      <p>
        ...
        >
          the mapping of your collection will be determined by the persistence engine as you create
          new documents</a
      ...
      <ul>
        <li>
          Defining the mapping for a collection enables you to specify the types of the attibutes of
          the object contained into it.
        </li>
        <li>
          If you want to edit the mapping of the current collection, once it's created, you can
          click on "Edit collection" in the context, right after its name. You will access this
          wizard.
        </li>
        <li>
          Once specified, the fields of a mapping cannot be updated or deleted, you will only be
          able to add new fields.
        </li>
        <li>
          Once your collection has a mapping, you can associate its fields with a set of form fields
          using this wizard. This will enable you to setup a form that will ease the creation of
          documents.
        </li>
      </ul>
    </div>
...
export default {
  ...
  computed: {
    flatMapping() {
      return mapValues(this.$store.direct.getters.collection.flattenMapping, (value, key) => {
