      ...
      .state('collection', {
        ...
        views: {
          bodyView: {
            templateProvider: ($q) => {
              return $q((resolve) => {
                require.ensure([], () => resolve(require('../../../templates/data/collection/index.template.html')));
              });
            }
          }
        },
      ...
      .state('collection.browse', {
        ...
        views: {
          mainView: {
            templateProvider: ($q) => {
              return $q((resolve) => {
                require.ensure([], () => resolve(require('../../../templates/data/collection/browse.template.html')));
              });
            }
          }
        },
      ...
      .state('collection.create', {
        ...
        views: {
          mainView: {
            templateProvider: ($q) => {
              return $q((resolve) => {
                require.ensure([], () => resolve(require('../../../templates/data/collection/full.template.html')));
              });
            }
          }
        },
