      ...
      .state('storage', {
        ...
        views: {
          bodyView:{
            templateProvider: ($q) => {
              return $q((resolve) => {
                require.ensure([], () => resolve(require('../../../templates/data/storage/index.template.html')));
              });
            }
          }
        },
      ...
      .state('storage.browse', {
        ...
        views: {
          mainView: {
            templateProvider: ($q) => {
              return $q((resolve) => {
                require.ensure([], () => resolve(require('../../../templates/data/storage/browse.template.html')));
              });
            }
          }
        },
      ...
      .state('storage.browse.documents', {
        ...
        views: {
          subView: {
            templateProvider: ($q) => {
              return $q((resolve) => {
                require.ensure([], () => resolve(require('../../../templates/data/storage/browse-documents.template.html')));
              });
            }
          }
        },
      ...
      .state('storage.create', {
        ...
        views: {
          mainView: {
            templateProvider: ($q) => {
              return $q((resolve) => {
                require.ensure([], () => resolve(require('../../../templates/data/storage/full.template.html')));
              });
            }
          }
        },
