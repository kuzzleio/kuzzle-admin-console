...
} from '../../../../src/services/filterFormatRealtime'
...
describe('filterFormatRealtime tests', () => {
  describe('formatFromBasicSearch tests', () => {
    ...
    it('should return object with regexp operator', () => {
      expect(formatFromBasicSearch([[{operator: 'regexp', attribute: 'foo', value: 'bar'}]])).to.deep.equals({
        or: [{
          and: [{
            regexp: {foo: 'bar'}
          }]
    ...
    it('should return object with exists operator', () => {
      expect(formatFromBasicSearch([[{operator: 'exists', attribute: 'foo', value: ''}]])).to.deep.equals({
        or: [{
          and: [{
            exists: {field: 'foo'}
          }]
    ...
    it('should return object with missing operator', () => {
      expect(formatFromBasicSearch([[{operator: 'missing', attribute: 'foo', value: ''}]])).to.deep.equals({
        or: [{
          and: [{
            missing: {field: 'foo'}
          }]
