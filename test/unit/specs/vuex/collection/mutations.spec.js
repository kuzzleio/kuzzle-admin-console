...
import { RECEIVE_COLLECTION_DETAIL, RESET_COLLECTION_DETAIL } from '../../../../../src/vuex/modules/collection/mutation-types'
...
describe('Collection mutation test', () => {
  it('should set name, mapping and realtimeOnly correctly', () => {
    ...
    mutations[RECEIVE_COLLECTION_DETAIL](state, {name: 'toto', mapping: {toto: 'tutu'}, isRealtimeOnly: true, schema: {tata: 'titi'}, allowForm: true})
